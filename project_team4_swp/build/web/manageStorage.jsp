...
<html>
    ...
    <body>
                ...
                <div class="box_wraper_content">
                    ...
                    <div  class="box_content"> 
                        ...
                        <div class="items"> 
                            ...
                            <input  class="readOnly" id="storageId" readonly="" value="1">
                        </div>
                        <div class="items"> 
                            <label>Tên sản phẩm: </label>
                            <input title="" class="readOnly" id="nameProduct" readonly="" value="vitets">
                        </div>

                        <div class="items"> 
                            <label>Số seri:</label>
                            <input class="" id="seri"  value="">
                        </div>
                        <div class="items"> 
                            <label>Code:</label>
                            <input class="" id="seri"  value="">
                        ...
                        <div class="items"> 
                            ...
                            <input class="" id="seri"  value="">
                            <label class="error">Sai định dạng</label>
                        </div>

                        <div class="items"> 
                            <label>Ngày tạo: </label>
                            <input title="" class="readOnly" id="nameProduct" readonly="" value="">
                        </div>
                        <div class="items"> 
                            <label>Status:</label>
                        ...
                        <div class="items"> 
                            ...
                            <div class="group_chose">
                                ...
                                <input data-datasql="checked" checked="" type="radio" name="group_isDelete" id="isDelete2" value="0">
                        ...
                        <div class="group_button">
                            ...
                            <button class="ok_btn btn_2" onclick="updateInfoStorage(this)">Update</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="list_wraper">
                    <div class="filter">
                        ...
                        <div class="search_container">
                            <div class="search">
                                <input id="search_content" type="text" class="" placeholder="Tìm kiếm theo id" >
                            </div>
                        </div>
                        ...
                        <div class="dropdown_container">
                            <select id="filterisShow" class="custom_select">
                                <option selected="" value="status" style="color: black;">Trạng thái trên web</option>
                                <option value="1" style="color: black;">Đang bán</option>
                                <option value="0" style="color: black;">Đã bán</option>
                            </select>
                        </div>
                        <div class="dropdown_container">
                            <select id="filterisDelete" class="custom_select">
                                <option selected="" value="isDelete" style="color: black;">Trạng thái thẻ</option>
        ...
        <script src="./js/manageStorage.js"></script>
